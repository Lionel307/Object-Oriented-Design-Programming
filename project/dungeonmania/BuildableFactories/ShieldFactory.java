...
public class ShieldFactory extends BuildableFactory {

    @Override
    public boolean isBuildable(Inventory inventory, Collection<Entity> entities) {
        return inventory.getNumOfTypes(Wood.class) >= 2 && 
